...
class RoutsControllerTest < ActionController::TestCase
  ...
  test "should create rout" do
    assert_difference('Rout.count') do
      post :create, rout: { address: @rout.address, description: @rout.description, latitude: @rout.latitude, longitude: @rout.longitude, title: @rout.title, user_id: @rout.user_id }
    end
  ...
  test "should update rout" do
    put :update, id: @rout, rout: { address: @rout.address, description: @rout.description, latitude: @rout.latitude, longitude: @rout.longitude, title: @rout.title, user_id: @rout.user_id }
    assert_redirected_to rout_path(assigns(:rout))
  end
